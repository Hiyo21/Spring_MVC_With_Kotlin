...
public class AbstractDispatcherServletTest implements AfterRunService {
    ...
    public AbstractDispatcherServletTest setServletPath(String servletPath) {
        if(this.req == null) this.servletPath = servletPath;
        else this.req.setServletPath(servletPath);
        return this;
    }

    public AbstractDispatcherServletTest initRequest(String requestUri, String method) {
        this.req = new MockHttpServletRequest(method, requestUri);
    ...
    public AbstractDispatcherServletTest addParameter(String name, String value) {
        if (this.req == null) throw new IllegalStateException("request가 초기화되지 않았습니다.");
        this.req.addParameter(name, value);
        return this;
    }

    public AbstractDispatcherServletTest buildDispatcherServlet() throws ServletException {
        if(this.classes == null && this.locations == null && this.relativeLocations == null) throw new IllegalStateException("Classes 와 locations 중 하나는 설정해야 합니다.");
    ...
    public AfterRunService runService() throws ServletException, IOException {
        ...
        if (this.req == null) throw new IllegalStateException("request가 준비되지 않았습니다.");
        this.dispatcherServlet.service(this.req, this.res);
        return this;
    }
    ...
    public WebApplicationContext getContext() {
        if(this.dispatcherServlet == null) throw new IllegalStateException(("DispatcherServet이 준비되지 않았습니다."));
    ...
    public AfterRunService assertModel(String name, Object value) {
        Assert.assertEquals(this.getModelAndView().getModel().get(name), value);
        return this;
    }

    public AfterRunService assertViewName(String viewName) {
        Assert.assertEquals(this.getModelAndView().getViewName(), viewName);
        return this;
    }
